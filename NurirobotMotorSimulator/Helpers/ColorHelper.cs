...
namespace NurirobotMotorSimulator.Helpers
{
    public static class ColorHelper
    {
        ...
        private static Color ThrowFormatException() => throw new FormatException("The parameter \"colorString\" is not a recognized Color format.");

        private static void ThrowArgumentException() => throw new ArgumentException("The parameter \"colorString\" must not be null or empty.");
